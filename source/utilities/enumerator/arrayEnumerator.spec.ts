...
describe('ArrayEnumerator', () => {
	...
	it ('should not break when moving past end', function() {
		let enumerator = new ArrayEnumerator([5]);
	...
	it ('should reset from the beginning', function() {
		let enumerator = new ArrayEnumerator([1, 2, 3]);
